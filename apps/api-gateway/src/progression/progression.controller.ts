...
import { NATS_SERVICE, NatsPattern, IProgressionData } from '@repo/shared-types';
...
export class ProgressionController {
  ...
  async getLeaderboard(
    ...
    const result = await firstValueFrom(
      this.natsClient.send(NatsPattern.PROGRESSION_GET_LEADERBOARD, { type: leaderboardType }),
    );
