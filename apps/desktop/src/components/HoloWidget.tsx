...
export default function HoloWidget() {
    ...
    const handleKeyPress = () => {
        ...
        comboTimeoutRef.current = setTimeout(() => setCombo(0), 2000) as unknown as number;
    };
    ...
    useEffect(() => {
        ...
        window.electronAPI?.onUserKeyPress(() => {
            handleKeyPress();
        });
    ...
    const buildProgress = gameState.experienceToNext > 0
        ...
        return (
            ...
            >
                ...
                <div className="holo-widget__collapsed-tooltip">
                    <span className="holo-widget__collapsed-loc">{formatNumber(gameState.linesOfCode)}</span>
        ...
        >
            ...
            {showLevelUp && (
                <div className="holo-widget__level-up">
                    ...
                    <div className="holo-widget__level-up-text">
                        <span className="holo-widget__level-up-label">git push origin main</span>
                        <span className="holo-widget__level-up-version">v{levelToVersion(gameState.level)}</span>
                    </div>
                </div>
            )}
                ...
                <div className="holo-widget__title">
                    ...
                    {combo > 5 && (
                        <span className="holo-widget__combo-badge">
                            <span className="holo-widget__combo-x">×</span>{combo}
                        </span>
                    )}
                </div>
                ...
                <div className="holo-widget__stats-panel">
                    ...
                    <div className="holo-widget__loc-display">
                        <div className="holo-widget__loc-header">
                            ...
                            <span className="holo-widget__loc-tier">{getLevelTier(gameState.level)}</span>
                        </div>
                        <div className="holo-widget__loc-value">
                            <span className="holo-widget__loc-number">{formatNumber(gameState.linesOfCode)}</span>
                    ...
                    <div className="holo-widget__metrics">
                        <div className="holo-widget__metric">
                            ...
                            <div className="holo-widget__metric-data">
                                <span className="holo-widget__metric-value">×{gameState.multiplier.toFixed(1)}</span>
                        ...
                        <div className="holo-widget__metric">
                            ...
                            <div className="holo-widget__metric-data">
                                <span className="holo-widget__metric-value">
                                    {gameState.passiveRate > 0 ? `+${gameState.passiveRate.toFixed(1)}` : '0.0'}
                                </span>
                        ...
                        <div className="holo-widget__metric">
                            <span className="holo-widget__metric-icon">⌨</span>
                            <div className="holo-widget__metric-data">
                                <span className="holo-widget__metric-value">{formatNumber(gameState.totalKeyPresses)}</span>
            ...
            <div className="holo-widget__footer">
                <div className="holo-widget__build-info">
                    ...
                    <span className="holo-widget__version-badge">v{levelToVersion(gameState.level)}</span>
                    <span className="holo-widget__build-progress-text">{Math.floor(buildProgress)}%</span>
                </div>
